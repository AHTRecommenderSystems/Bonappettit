								...
								<div class="dropdown-menu dropdown-settings">
									<div class="media">
										<form role="form" method="post" action="login.jsp">
											<button type="submit" class="btn btn-default">Cerrar
				...
				<div class="col-lg-4">
					<div class="input-group">
						<input type="text" class="form-control"
							placeholder="Estoy Buscando...."> <span
		...
		<div class="content-wrapper">
			<div class="container">
				<ul class="nav nav-tabs">
					<li class="active">
						<a data-toggle="tab" href="#add_dish">Agregar Platillo</a>
					</li>
					<li>
						<a data-toggle="tab" href="#edit_dish">Modificar Platillo</a>
					</li>
					<li>
						<a data-toggle="tab" href="#delete_dish">Eliminar Platillo</a>
					</li>
				</ul>
												...
												<div class="row">
													<div class="col-lg-9">
														...
														<br> <br> <br> <input type="submit"
															name="submit" id="submit" value="Agregarsun"
					...
					<div id="edit_dish" class="tab-pane fade">
						...
						<div class="row">
							<div class="col-lg-5">
								<div class="input-group">
									<input type="text" class="form-control"
										placeholder="Buscar Platillo...."> <span
										class="input-group-btn">
										<button class="btn btn-default" type="button">
											<span class="glyphicon glyphicon-search"></span>
										</button>
								...
								if(dishes != null) {
									for(Dish dish : dishes) {
										out.println("<tr>");
											...
											out.println("<td>");
												out.println("<button type='submit' class='btn btn-info'>Modificar</button>");
											out.println("</td>");
										out.println("</tr>");
									}									
								}				
							...
							<form role="form" method="post" action="create.jsp">
								<div class="col-lg-6">
									...
									<div class="form-group">
										...
										<div class="input-group">
											<input type="text" class="form-control" name="InputName"
												id="InputName" placeholder="Nombre" required> <span
									...
									<div class="form-group">
										...
										<div class="input-group">
											<textarea name="InputMessage" id="InputMessage"
												placeholder="ingredientes" class="form-control" rows="5"
												required></textarea>
											<span class="input-group-addon"><span
												class="glyphicon glyphicon-asterisk"></span></span>
										</div>
								...
								if(dishes != null) {
									for(Dish dish : dishes) {
										out.println("<tr>");
											...
											out.println("<td>");
												out.println("<a href='eliminar.jsp?id=" + dish.getId() + "'> <button type='submit' class='btn btn-danger'>Eliminar</button></a>");
											out.println("</td>");
										out.println("</tr>");
									}									
								}				
